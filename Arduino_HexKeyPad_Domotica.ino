            ...
            void loop() {
               ...
               char avail= ' ';
                  ...
                  if(Serial.available() > 0){                                             //Checa si hay algun byte disponible para lectura en serial y que sea menor a 7

                   if(count==0){
                     ardID = Serial.readString();
                  ...
                  if(claveSerial[0] == 1){                                                 //Si el primer # en el arreglo es 1 se cambia la clave master
                     if((claveGuest[1]!= claveSerial[1])&&(claveGuest[2]!= claveSerial[2])&&(claveGuest[3]!= claveSerial[3])&&(claveGuest[4]!= claveSerial[4])){
                      ...
                      Serial.println("Las claves no puedes ser iguales");
                      count = 1;
                     }
                  }
                  else if(claveSerial[0] == 2){                                            //Si el primer # en el arrgelo es 2 se cambia la clave guest
                     if((claveMaster[1]!= claveSerial[1])&&(claveMaster[2]!= claveSerial[2])&&(claveMaster[3]!= claveSerial[3])&&(claveMaster[4]!= claveSerial[4])){
